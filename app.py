...
st.set_page_config(
   page_title="Vehicle routing",
   page_icon="🚚",
   layout="centered",
   menu_items={
      'About': "#### Get optimized road routes easily!",
      'Report a bug': "https://github.com/RutvikJ77/Multi-routing",
    }
)
...
st.write('Vehicle routing for: ', str(d)+"\tT"+"07:00"+":00.000Z")
...
vehicle_amount = form.text_input('No. of Vehicles', 10)
...
if valid_file:
    ...
    client = ors.Client(key=os.getenv('ORSKEY'))
